...
$query = "SELECT * FROM trainingsets, progress WHERE trainingsets.ID = progress.setID AND progress.userID={$id} AND EXISTS (SELECT * FROM categories WHERE categories.setID=trainingsets.ID AND category='physics')";
...
$query = "SELECT * FROM trainingsets WHERE NOT EXISTS (SELECT * FROM progress WHERE userID={$id} AND setID=ID) AND EXISTS (SELECT * FROM categories WHERE categories.setID=trainingsets.ID AND category='physics')";
$result = mysql_query($query) or die(mysql_error());
